...
echo "Starting Robot ..."
jybot --outputdir log --pythonpath $PYTHONPATH --variable ROBOT_WORKSPACE_RESOURCE:$ROBOT_WORKSPACE_RESOURCE_FILE --variable SUT_RESOURCE:$SUT_RESOURCE_FILE MOC_PREPAID_ONNET-LongDuration136s-robot-suite.txt
