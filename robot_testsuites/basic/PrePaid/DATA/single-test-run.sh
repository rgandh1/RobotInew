...
echo "Starting Robot ..."
jybot --outputdir log --pythonpath $PYTHONPATH --test 'CG Short TwoAccountsCharged Data Session'  --variable ROBOT_WORKSPACE_RESOURCE:$ROBOT_WORKSPACE_RESOURCE_FILE --variable SUT_RESOURCE:$SUT_RESOURCE_FILE data-regression-suite.txt
