...
echo "Starting Robot ..."
jybot --outputdir log --include test --pythonpath $PYTHONPATH_DBLIBRARY --variable ROBOT_WORKSPACE_RESOURCE:$ROBOT_WORKSPACE_RESOURCE_FILE --variable SUT_RESOURCE:$SUT_RESOURCE_FILE XDR_Test-robot-suite.txt
