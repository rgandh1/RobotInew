...
SUT_RESOURCE_FILE=$WORKSPACE_PATH/suts/mTel_PPL_TB25-resource.txt
...
echo "Starting Robot ..."
jybot --outputdir log --pythonpath $PYTHONPATH --variable ROBOT_WORKSPACE_RESOURCE:$ROBOT_WORKSPACE_RESOURCE_FILE --variable SUT_RESOURCE:$SUT_RESOURCE_FILE MOC_POSTPAID_ONNET-LongDuration196s-robot-suite.txt
