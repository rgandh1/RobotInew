...
echo "Starting Robot ..."
jybot --outputdir log --pythonpath $PYTHONPATH -i MTC_only -i POSTPAID_only --variable ROBOT_WORKSPACE_RESOURCE:$ROBOT_WORKSPACE_RESOURCE_FILE --variable SUT_RESOURCE:$SUT_RESOURCE_FILE . 
