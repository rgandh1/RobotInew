...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include USSD_onlyANDMVNA_MEX_specific $WORKSPACE_PATH/robot_testsuites
#################################
