...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --include MVNA_MEX_supportedANDXDR_only --exclude experimental $WORKSPACE_PATH/robot_testsuites
#################################
