...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include MVNA_MEX_supportedANDDATA_only $WORKSPACE_PATH/robot_testsuites
#################################
