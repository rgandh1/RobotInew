...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include USSD_onlyANDSMARTSPACE_specific $WORKSPACE_PATH/robot_testsuites
#################################
