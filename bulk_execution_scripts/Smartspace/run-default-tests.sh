...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --exclude End2EndTest --include SMARTSPACE_supported $WORKSPACE_PATH/robot_testsuites
