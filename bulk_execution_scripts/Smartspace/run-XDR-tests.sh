...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --include SMARTSPACE_supportedANDXDR_only --exclude experimental $WORKSPACE_PATH/robot_testsuites
#################################
