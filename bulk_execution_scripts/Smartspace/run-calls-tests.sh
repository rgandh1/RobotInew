...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include SMARTSPACE_supportedANDcalls $WORKSPACE_PATH/robot_testsuites
#################################
