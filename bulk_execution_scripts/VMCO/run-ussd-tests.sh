...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include VIRGIN_COLUMBIA_specificANDUSSD_only $WORKSPACE_PATH/robot_testsuites
#################################
