...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include VIRGIN_COLUMBIA_supportedANDcalls $WORKSPACE_PATH/robot_testsuites
#################################
