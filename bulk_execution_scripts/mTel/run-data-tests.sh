...
#################################
jybot --argumentfile ../default.args --argumentfile sut-specific.args --exclude experimental --include MTEL_supportedANDDATA_only $WORKSPACE_PATH/robot_testsuites
#################################
